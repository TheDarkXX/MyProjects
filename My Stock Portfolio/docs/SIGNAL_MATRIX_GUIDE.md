...
graph TD
    ...
    L0 -->|ไม่ผ่าน VETO| Mayday[❌ MAYDAY_EXIT / 🔪 SLOW_BLEED]
    ...
    L1 -->|วิ่งลอยฟ้าเหนือ EMA 150| Moon[🚀 TO THE MOON นั่งทับมือปล่อยกำไรวิ่ง]
    L1 -->|เทรนด์ปกติ / ไม่มีสัญญาณ| Radar[📡 ON RADAR เฝ้าสังเกตการณ์]
```
...
| **Tier 5** | **ON RADAR** | 📡 | โมโนโครม สเตลธ์ คอนทราสต์ 70%<br>`Stealth Slate` | ราคาวิ่งตามเทรนด์ปกติ หุ้นลอยฟ้าไร้สถานะ | **เฝ้าสังเกตการณ์** ห้ามไล่ราคาที่ยอดดอย | **0% (เฝ้าดู)** |
...
| **Tier 7** | **MAYDAY EXIT** | ❌ | แดงกะพริบเตือนภัยสองจังหวะ<br>`animate-flash-alert` | มีดร่วง หลุดลึกเกิน -8% โครงสร้างหลักพัง | **พิจารณาคัทลอส / หยุดขาดทุน** ปกป้องทุน | **Exit / Short** |
...
#### 🔴 Scenario 1: Falling Knife (มีดร่วง) ➔ `MAYDAY_EXIT` ❌
> **นิยาม:** หุ้นถูกทุบหลุดต่ำกว่าเส้น EMA 200 เกิน -8% โดยที่สถาบันหนีเตลิด (Banker = 0)
...
| 3 | **Actionable VETO** | **ระงับคำสั่งซื้อทุกกรณี / ออกมาถือเงินสด** |

---

#### 🔴 Scenario 2: Dead Cat Bounce (เด้งหลอกใต้น้ำ) ➔ `MAYDAY_EXIT` ❌
> **นิยาม:** ราคาจมลึกใต้ EMA 200 เกิน -8% ในเทรนด์ขาลง (BEAR) พยายามดีดตัวด้วยแรงสถาบันกระปริบกระปรอย (1-6)
...
| 4 | **Actionable VETO** | **ห้ามตาม / เสี่ยงกับดักเด้งหลอก** |

---

#### 🔴 Scenario 3: Core Breakdown (โครงสร้างหลักพัง) ➔ `MAYDAY_EXIT` ❌
> **นิยาม:** หลุดแช่อยู่ใต้เส้น EMA 200 ลึกกว่า -5% ต่อเนื่องนานเกิน 5 วันทำการในเทรนด์ BEAR
...
| 1 | **EMA Regime** | `BEAR` |
| 2 | **Dist EMA 200** | $< -5.0\%$ |
| 3 | **Days Below EMA 200** | $\ge 5$ วันทำการ |
| 4 | **Actionable Mandate** | **ตัดขาดทุนทันที (Stop-Loss)** |
...
### [LAYER 4: TREND RUNNERS] รันเทรนด์กำไรวิ่ง

#### 🚀 Scenario 14 (มีหุ้นในพอร์ต): To The Moon ➔ `TO_THE_MOON` 🚀
> **นิยาม:** หุ้นวิ่งทะยาน $+15\%$ (Core) หรือ $+25\%$ (Moonshot) เหนือเส้น EMA 150 สถาบันเกาะแน่น
- **แอคชั่น:** นั่งทับมือ ปล่อยกำไรวิ่งตามเทรนด์ ห้ามขายหมู
...
#### 📡 Scenario 14 (ไม่มีหุ้นในพอร์ต): Overbought Run ➔ `ON_RADAR` 📡
> **นิยาม:** หุ้นวิ่งลอยฟ้าเหมือนกรณีข้างต้น แต่เราไม่มีของในมือ
- **แอคชั่น:** **ห้ามไล่ราคาเด็ดขาด** แปะไว้บนเรดาร์ รอย่อตัวแตะแนวรับรอบใหม่

| เช็คลิสต์ | เกณฑ์การตรวจสอบ | ผลลัพธ์ที่ต้องผ่าน |
|:---:|:---|:---:|
| 1 | **Dist EMA 150** | อยู่ในโซนสูง Overbought |
| 2 | **Holdings Status** | **ไม่มีหุ้นในพอร์ต (`ownedShares = 0`)** |
| 3 | **Actionable Mandate** | **ON RADAR 📡 (Do Not Chase Highs)** |

---

#### 🚀 Scenario 15: Surfing Trend Runner ➔ `TO_THE_MOON` 🚀
> **นิยาม:** ขาขึ้นสมบูรณ์แบบ (50 > 150 > 200) ราคาโต้คลื่นยืนเหนือเส้น EMA 9 สถาบันคุมเข้ม
- **แอคชั่น:** ถือรันเทรนด์เต็มสูบ
...
| 3 | **Dist EMA 150** | $> +4.0\%$ |
| 4 | **Banker MCDX** | $\ge 10$ |
| 5 | **Actionable Mandate** | **TO THE MOON 🚀** |

---

### [LAYER 5: STEALTH RADAR] สังเกตการณ์ตามเทรนด์

#### 📡 Scenario 16: Default Matrix / Consolidating ➔ `ON_RADAR` 📡
> **นิยาม:** หุ้นวิ่งอยู่ในเทรนด์ปกติ ยังไม่เข้าเกณฑ์แนวรับหรือสัญญาณกลับตัว
- **ระดับย่อย:**
  - `Consolidating`: ราคาแกว่งตัวปกติ
  - `Healthy Dip`: ย่อตัวปกติ $-1\%$ ถึง $-3\%$ vs EMA 150
  - `Deep Pullback`: ย่อลึก $-3\%$ ถึง $-6\%$ เริ่มน่าจับตา
  - `Approaching Bedrock`: กำลังดิ่งลงหาแนวรับหินผา EMA 200
...
| **Dist EMA 200** | $\approx 0\%$ | แตะรอบ 2 | เคยหลุด $\rightarrow$ ปิดเหนือ | — | — | แตะเส้น 200 | $\pm 3\%$ ($\ge 5$d) | $< 0\%$ | $< -8\%$ |
