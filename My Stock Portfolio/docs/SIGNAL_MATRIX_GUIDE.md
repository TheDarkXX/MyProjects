...
| **Tier 7** | **FALLING KNIFE / MAYDAY EXIT** | 🔪 / ❌ | แดงกะพริบเตือนภัยสองจังหวะ<br>`animate-flash-alert` | มีดร่วง หลุดลึกเกิน -8% โครงสร้างหลักพัง<br>• มีหุ้นในพอร์ต: **MAYDAY EXIT ❌**<br>• ไม่มีหุ้นในพอร์ต: **FALLING KNIFE 🔪** | • **มีของ:** **สละเรือ / คัทลอสหนีตายทันที**<br>• **ไม่มีของ:** **ห้ามรับมีดเด็ดขาด! รอสะเด็ดน้ำ** | **มีของ: Exit / Short**<br>**ไม่มีของ: 0% (Cash)** |
