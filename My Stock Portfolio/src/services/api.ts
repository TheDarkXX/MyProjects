...
export const api = {
  ...
  ai: {
    ...
    advisor: (mode: string, blueprints: any[], fundamentals: any, portfolio_id: string, force = false) => authFetch('/ai-advisor', { method: 'POST', body: JSON.stringify({ mode, blueprints, fundamentals, portfolio_id, force }) }),
