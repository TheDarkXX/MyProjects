...
export const DoublerPowerTube: React.FC<DoublerPowerTubeProps> = ({
  ...
  return (
    <div className="flex-1 w-full bg-gradient-to-r from-[#060B1C]/90 via-[#0B1530]/90 to-[#140A1E]/90 p-3 rounded-2xl border border-blue-800/40 shadow-[0_4px_24px_rgba(0,0,0,0.5)]">
      ...
      <div className="relative w-full h-8 bg-[#040815] rounded-xl p-1 border border-blue-900/60 shadow-inner flex items-center overflow-hidden">
        ...
        <div
          className="relative h-full rounded-lg bg-gradient-to-r from-blue-600 via-cyan-400 to-emerald-400 shadow-[0_0_16px_rgba(56,189,248,0.5)] transition-all duration-1000 flex items-center justify-end px-2.5"
      ...
      <div className="flex items-center justify-between text-xs sm:text-sm text-slate-300 mt-2 px-1 font-mono">
