    ...
    return (
      ...
      >
        <div
          ...
          className="inline-flex items-center gap-2 px-2.5 py-0.5 rounded-md bg-[#0B101B]/95 hover:bg-slate-800/95 border border-slate-700/80 shadow-lg text-[13px] text-slate-300 hover:text-white cursor-pointer transition-all select-none group"
          title={`คลิกเพื่อเปิดขยาย ${title} กลับมา`}
        >
          <span className="px-1.5 py-0.5 rounded bg-slate-800 text-[11px] font-bold text-cyan-300 border border-slate-700 leading-none">
            P{paneIndex}
          </span>
          <span className="font-extrabold text-slate-200 tracking-wide">{title}</span>
          <span className="text-[12px] text-slate-400">(พับเก็บ)</span>
          <span className="flex items-center gap-1 text-[12px] font-bold text-cyan-400 group-hover:text-cyan-300 ml-1 bg-cyan-950/50 px-1.5 py-0.5 rounded border border-cyan-800/40">
