...
- **[My Stock Portfolio] Project 2X: Stock X-Ray V2.37 Institutional Audit, Bug Smashing, Analyst Target Consensus & Live Portfolio Sync (V2.36.0 / V2.37.0)**: ปฏิรูปหน้า Stock X-Ray เป็น 3 แท็บย่อยระดับสถาบัน (Mission Control, Financial Pulse 3-Column, 2X Thesis & Moat), พัฒนาชาร์ต Valuation Corridor 3Y, CAGR Trajectory, แผงวิเคราะห์เป้าหมายนักวิเคราะห์ Institutional Consensus (Range Bar, Recommendation Pill, Forward Growth, Earnings Date), แก้บั๊กใหญ่ 4 จุด (Tactical Pulse 52-Week Crosshair, Execution Slip เชื่อมต่อพอร์ตจริง $183.08/2.5399 หุ้น, Default คอลัมน์อิสระรายแท็บ 2/3/3, และแก้ Tooltip คอนทราสต์ต่ำ), กวาดล้างข้อมูล Hardcoded ด้วยการ Sync จาก Yahoo Finance, และเพิ่มวิชวลชาร์ต Moat Circular Gauge & Scenarios Bar
