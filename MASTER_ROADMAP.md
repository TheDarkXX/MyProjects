...
- **[My Stock Portfolio] News Intelligence: Multi-View Switcher (5 Modes), Edge-to-Edge Layout & Instant 0ms In-Memory Filtering (V2.30.0)**: ยกเครื่องความกว้างเต็มจอ Edge-to-Edge ไร้ขอบดำ, ระบบ View Switcher 5 โหมด (List 3-Col, Bullet Text 16px, Mini Card 3-4 Col, Big Card 2-Col, Full View), Smart Sorting 5 มิติ (Date, Ticker, Priority, Score, Sentiment), และผ่าตัดระบบ In-Memory Filter 0ms ขจัดปัญหา Loading Spinner หมุนวนทุกครั้งที่คลิกตัวกรอง
