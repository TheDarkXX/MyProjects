...
5. **Copy to Research folder:**
   ```powershell
   Copy-Item -Path ".\report_*.md" -Destination "C:\My Claw\MyProjects\DoctorBank-Band\Content\Research\<TopicName>.md"
   ```
...
|-------|--------------------------|
| `/cons` | ต้องการ quick peer-reviewed evidence check จาก Consensus (10-30s) ไม่จำกัดจำนวน cite |
