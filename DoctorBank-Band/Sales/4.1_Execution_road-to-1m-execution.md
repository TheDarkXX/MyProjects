...
| 6 | "3 แถม 1 ราคานี้ มีแค่ช่วงนี้... ตกขวดละ 642.5 บาท" | Promo | 🟢 Talking Head |
...
> จุดเน้น SKU C: "4 กระปุก ตก 642.5 บาท/ขวด คุ้มที่สุด!" (จากราคาเซต 2,670 บาท)
...
🔥 3 แถม 1 ปกติ 2,670 → LIVE วันนี้ 2,490! ได้ 4 กระปุก! (ตกขวดละ 622.5)

> 💡 **การตั้งค่าในระบบ (คิดย้อนกลับจากราคาที่ต้องการขาย):**
> - 1 กระปุก: ตั้งราคาเต็ม 1,990 บาท + ส่วนลดโปรโมชัน 55% = ขายจริง 890 บาท (ลูกค้าเก็บคูปองลดอีก 100 เหลือ 790)
> - เซตคู่ 2 กระปุก: ตั้งราคาเต็ม 3,980 บาท + ส่วนลดโปรโมชัน 60% = ขายจริง 1,590 บาท (ลูกค้าเก็บคูปองลดอีก 100 เหลือ 1,490)
> - 3 แถม 1 (4 กระปุก): ตั้งราคาเต็ม 7,960 บาท + ส่วนลดโปรโมชัน 66% = ขายจริง 2,670 บาท (ลูกค้าเก็บคูปองลดอีก 100 เหลือ 2,570)
