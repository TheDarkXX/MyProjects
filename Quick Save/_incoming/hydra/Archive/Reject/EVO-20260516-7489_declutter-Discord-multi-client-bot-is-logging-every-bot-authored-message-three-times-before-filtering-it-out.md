...
brain_task_id: ~
source: oracle
proposal_id: EVO-20260516-7489
tags: [oracle, declutter, optimization]
summary: >
  Oracle optimization finding: Discord multi-client bot is logging every bot-authored message three times before filtering it out
---

# Oracle Proposal (EVO-20260516-7489)
**Mission:** declutter
**Level:** optimization
**Title:** Discord multi-client bot is logging every bot-authored message three times before filtering it out
...
## Recommended Action
Move the debug log line after `if (message.author.bot) return` and after the channel/bot assignment check, or gate it behind a DEBUG flag. Keep only actionable logs for messages the assigned bot will actually process.
