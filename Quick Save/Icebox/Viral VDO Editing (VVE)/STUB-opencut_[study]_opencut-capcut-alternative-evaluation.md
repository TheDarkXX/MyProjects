...
- **2026-08-23** | [OpenPud STT Evaluation](../OpenPud/STUB-openpud_[study]_speech-to-text-desktop-evaluation.md) -- External tool evaluation (Electron desktop app) ที่ถูก icebox เช่นกัน — pattern เดียวกันคือ standalone tool ที่ไม่ fit AG pipeline
