...
### enables
- **2026-09-14 12:50** | [V2.25.0 [impl] UI: X-Chart Watchlist Target Section (Project 2X Quotas) & Universal Collapse/Expand All with Cloud Sync](file:///c:/My%20Claw/MyProjects/Quick%20Save/Complete/My%20Stock%20Portfolio/V2.25.0_%5Bimpl%5D_ui_xchart-watchlist-target-section-and-collapse-all.md) -- ซิงก์สถานะพับ/กางของ Watchlist ทุกลิสต์ผ่าน `pushSettingDebounced`
- **2026-09-13 22:45** | [V2.24.0 [impl] UI: X-Chart Contextual Position HUD, Bloomberg Nano-Strip, HTML5 Pointer Drag & Cost Line](file:///c:/My%20Claw/MyProjects/Quick%20Save/Complete/My%20Stock%20Portfolio/V2.24.0_%5Bimpl%5D_ui_xchart-contextual-position-hud-drag-and-cost-line.md) -- เชื่อมต่อ Position Overlay Settings เข้ากับ Universal Cloud Settings Sync Engine
